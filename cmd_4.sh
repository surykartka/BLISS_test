...
weblogo -f mapping/R2_5prime/C1_S1_R2_first10.fa -D fasta -o mapping/R2_5prime/C1_S1_R2_first10.pdf -F pdf -A dna --errorbars no -c classic
weblogo -f mapping/R2_5prime/NB_S2_R2_first10.fa -D fasta -o mapping/R2_5prime/NB_S2_R2_first10.pdf -F pdf -A dna --errorbars no -c classic
